package com.example.myappnews.data

import androidx.lifecycle.LiveData
import androidx.lifecycle.MediatorLiveData
import com.dicoding.myappnews.data.local.entity.NewsEntity
import com.dicoding.myappnews.data.local.room.NewsDao
import com.dicoding.myappnews.data.remote.response.NewsResponse
import com.dicoding.myappnews.data.remote.retrofit.ApiService
import com.dicoding.mynewsapp.utils.AppExecutors
import com.example.myappnews.BuildConfig
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import com.example.myappnews.data.Result
...
class NewsRepository private constructor(
    ...
    fun getHeadlineNews(): LiveData<Result<List<NewsEntity>>> {
        ...
        val client = apiService.getNews("f42254bb5cb34454b27745b66fabd32a")
