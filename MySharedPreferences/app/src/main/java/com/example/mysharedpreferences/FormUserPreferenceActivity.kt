...
import com.example.mysharedpreferences.databinding.ActivityFormUserPrefenceBinding

class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding: ActivityFormUserPrefenceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFormUserPrefenceBinding.inflate(layoutInflater)
